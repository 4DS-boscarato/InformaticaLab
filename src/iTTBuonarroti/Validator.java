...
public class Validator {
    ...
    private static  String CAR_PLATE_PATTERN = "^[A-Z]{2}-[0-9]{3}-[A-Z]{2}$";
    private static  String CAP = "^[0-9]{5}$";
    ...
    private static  String URL_PATTERN = "^(https?|ftp)://([\\w_-]+(?:(?:\\.[\\w_-]+)+))([\\w.,@?^=%&:/~+#-]*[\\w@?^=%&/~+#-])?$";
    private static  String TAX_CODE_PATTERN = "^[A-Z]{6}\\d{2}[A-Z]\\d{2}[A-Z]\\d{3}[A-Z]$";
    ...
    public static boolean validateCarPlate(String carPlate) {
    ...
    public static boolean validateTaxCode(String taxCode) {
